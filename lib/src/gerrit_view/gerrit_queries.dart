...
@internal
String resolveRepoInfo(String? gerritRepo) {
...
@internal
(String, String, bool) resolveGerritDetails(String actualRepoRoot) {
...
@internal
Map<String, int> fetchLocalBranchIssues(String actualRepoRoot) {
...
@internal
BranchAnalysis buildBranchGroups(
...
@internal
CommitDetails? fetchCommitDetails(String repoPath, String branchName) {
  final result = Process.runSync('git', [
    'log',
    '-n',
    '1',
...
@internal
Map<int, ClStatus> fetchRemoteCLStatuses(
  String repoPath,
  List<int> clNumbers,
  String gerritHost,
) {
